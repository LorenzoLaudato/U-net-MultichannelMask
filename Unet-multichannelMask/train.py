...
def train_net(net,
    ...
    for epoch in range(1, epochs+1):
        ...
        if epoch%3==0:
            ...
            for i, item in enumerate(val_loader):
                ...
                with torch.no_grad():
                    ...
                    for j in range(batch_size):
                        ...
                        for k in range(8):   
                            save_predictions(true_masks[j,k,...],output[j,k,...],probs[j,k,...],one_hot[j,k,...],pred_masks[j,k,...],k, max_label, compact, black_mask, epoch, i,j, batch_size,dir_save_pred)
            ...
            writer.add_scalar("MSA/val",mean_seg_acc,epoch)
